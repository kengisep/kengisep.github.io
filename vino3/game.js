...
var score;
pjs.system.setTitle('Винишко-тян'); // Set Title for Tab or Window
...
game.newLoop('GameOver',function(){
	...
	if (mouse.isPeekObject('LEFT', pushVK)) {
		VK.api("wall.post", {"message": "В приложении Бегущая Рузиля я выпил: " + score + " бутылки вина" + "\n Присоединяйся и ты https://vk.com/app6229580", 
			"attachments" : "photo-154724360_456239122",}, function (data) {
...
game.newLoopFromConstructor('game', function()  {
	...
	var addvino = function(){
		var dV = oldVino? oldVino.x + pjs.math.random(900, 2000) : width;
	...
	var o = game.newAnimationObject({
		animation : pjs.tiles.newAnimation('img/преп7.png', 682, 853, 2),
		x : dX,y : 285*1.5625,
		delay : 100,
		w : 79*1.5625, h: 98*1.5625,
	});
	...
	var o2 = game.newAnimationObject({
		animation : pjs.tiles.newAnimation('img/преп6.png', 682, 853, 2),
		x : dX,y : 285*1.5625,
		delay : 100,
		w : 79*1.5625, h: 98*1.5625,
	});
